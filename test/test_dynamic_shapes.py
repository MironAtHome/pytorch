...
class TestSymNumberMagicMethods(TestCase):
    ...
    def test_dynamic_int_eager_usage(self):
        from torch.fx.experimental.symbolic_shapes import DynamicInt
        from torch.utils._sympy import functions as SF
        ...
        # NB: sympy functions specialize value
        self.assertEqual(SF.Mod(x, z), 0)
        self.assertEqual(SF.LShift(z, 1), 4)
        self.assertEqual(SF.FloatTrueDiv(y, z), 0.5)
        ...
        self.assertEqual(DynamicInt(x).val, x.val)
